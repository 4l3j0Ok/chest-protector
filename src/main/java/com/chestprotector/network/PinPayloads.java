package com.chestprotector.network;
...
public final class PinPayloads {
    ...
    public record OpenSetup(BlockPos pos) implements CustomPayload {
        public static final Id<OpenSetup> ID = new Id<>(Identifier.of(ChestProtector.MOD_ID, "open_setup"));
    ...
    public record OpenUnlock(BlockPos pos) implements CustomPayload {
        public static final Id<OpenUnlock> ID = new Id<>(Identifier.of(ChestProtector.MOD_ID, "open_unlock"));
    ...
    public record SubmitSetup(BlockPos pos, String pin) implements CustomPayload {
        public static final Id<SubmitSetup> ID = new Id<>(Identifier.of(ChestProtector.MOD_ID, "submit_setup"));
    ...
    public record SubmitUnlock(BlockPos pos, String pin) implements CustomPayload {
        public static final Id<SubmitUnlock> ID = new Id<>(Identifier.of(ChestProtector.MOD_ID, "submit_unlock"));
